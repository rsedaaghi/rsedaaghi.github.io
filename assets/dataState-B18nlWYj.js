import{a as w,g as b,r as k,u as S,j as s,s as R,c as $,b as j,m as U,S as M,a1 as f,a2 as g,e as u,T as A}from"./index-CGCkhIBh.js";function T(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function D(t){return parseFloat(t)}function X(t){return w("MuiSkeleton",t)}b("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const B=t=>{const{classes:e,variant:a,animation:n,hasChildren:i,width:o,height:r}=t;return j({root:["root",a,n,i&&"withChildren",i&&!o&&"fitContent",i&&!r&&"heightAuto"]},X,e)},l=g`
  0% {
    opacity: 1;
  }
